      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your appointment and communicate with our AI assistant
          </p>
        </div>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-4">
                {messages?.data?.map((message) => (
                  ...
                  >
                    ...
                    >
                      <p className="text-sm">{message.content.en}</p>
                      <p
                      ...
                      >
                        ...
                        {message.flags?.includes("AI_AUTO_REPLY") && "AI Agent"}
                      </p>
                    </div>
                  </div>
                ))}
              ...
              <div className="space-y-3">
                <div className="p-3 bg-blue-50 rounded-lg">
                  <p className="text-sm text-gray-700 mb-1">
                    <strong>Initial Booking:</strong> Patient reported chest
                ...
                <div className="p-3 bg-blue-50 rounded-lg">
                  <p className="text-sm text-gray-700 mb-1">
                    <strong>Follow-up:</strong> Symptoms reduced after
